...
async def send_welcome(message: types.Message):
    with Session(simple_engine) as session:
        ...
        if user:
            ...
            await message.reply(
                f"Привет, {user.name or 'друг'}! 👋 \n\nЯ *Figaro* — твой помощник на фестивале _«Безумные дни в Екатеринбурге»_. С моей помощью фестиваль будет как на ладони: маршрутный лист перед глазами, билеты всегда под рукой и своевременные напоминания о событиях дня.\n\nВыбери действие:",
