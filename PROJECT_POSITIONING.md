...
Пользователи фестиваля сталкивались с **8 х миллионов х миллиардов** возможных комбинаций маршрутов, что делало идеальное  планирование практически невозможным:
...
Пользователь выбиралне всегда именно _что хотел_, а только то, _что мог_, путался в расписании, жаловался на повторные покупки, пропущенные по забывчивости концерты, часто создавал себе не сбалансирвоанную программу и упускал уникальные события фестиваля. Как правило, ограничивался 3-4 концертами за все дни фестиваля, что не позволяло достигнуть одной из главных задач организаторов фестиваля: попробовать разное и выбрать лучшее.


## 🤖 Три уровня машинного обучения

**Figaro** реализует комплексный подход к машинному обучению на трех уровнях:

### 1️⃣ Разметка и кластеризация маршрутов
- **Обработка огромного количества маршрутов** - анализ _8 х миллионов х миллиардов_ комбинаций
- **Кластеризация по характеристикам** - группировка похожих маршрутов
- **Отсеивание худших вариантов** - автоматическое исключение неэффективных комбинаций
- **Оптимизация поиска** - быстрый доступ к релевантным маршрутам с учетом доступности билетов и истории покупок

### 2️⃣ Персонализированные рекомендации
- **Дополнение существующих маршрутов** - анализ уже купленных концертов
- **Cold start решения** - рекомендации для новых пользователей без истории
- **Балансировка предпочтений** - учет интеллектуальной ценности и комфорта, предложение нескольких сценариев приоритета

### 3️⃣ Языковая модель для описаний
- **Формирование естественных описаний** - переход от цифр к понятному тексту
- **Подчеркивание ценности выбора** - выделение уникальных характеристик маршрута
- **Персонализированные объяснения** - адаптация описаний под пользователя
- **Комфортное представление информации** - структурированные и читаемые описания
...
- **open-air фестивали** - множественные сцены, короткие сеты, непрерывное звучание
