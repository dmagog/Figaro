...
По этапам — [docs/06-mvp-roadmap.md](docs/06-mvp-roadmap.md). Версия **3.6.0** — завершён этап 6 (уведомления: outbox, диспетчер от часов, идемпотентность, ретраи). Дальше: этап 7 (импорт наличия из файла).
