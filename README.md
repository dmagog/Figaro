...
По этапам — [docs/06-mvp-roadmap.md](docs/06-mvp-roadmap.md). Версия **3.13.0** — **MVP завершён** (этапы 0–7) + офф-программа + **веб-слой** (регистрация+верификация, вход, анкета, подбор под анкету, редактирование листа с подсказками, админский пульт эмуляции, **дашборды исследователя** — обзор/архетипы/кривая наличия/псевдонимы покупателей; server-rendered + HTMX). Дальше: телеграм-бот, live-API CRM, сброс пароля в вебе.
