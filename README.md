...
По этапам — [docs/06-mvp-roadmap.md](docs/06-mvp-roadmap.md). Версия **3.11.0** — **MVP завершён** (этапы 0–7) + офф-программа + **веб-слой** (упрощённый вход, анкета холодного старта, подбор под анкету, редактирование листа с подсказками, **админский пульт эмуляции** — FestivalClock + режим наличия; server-rendered + HTMX). Дальше: регистрация+верификация в вебе, дашборды исследователя, бот, live-API CRM.
