...
По этапам — [docs/06-mvp-roadmap.md](docs/06-mvp-roadmap.md). Версия **3.4.0** — завершён этап 4 (подбор по архетипам, маршрутный лист с конфликтами/повторами, подсказки дополнения). Дальше: этап 5 (наличие и эмуляция).
