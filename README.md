...
По этапам — [docs/06-mvp-roadmap.md](docs/06-mvp-roadmap.md). Версия **3.5.0** — завершён этап 5 (наличие и эмуляция: кривая/реплей, тики от часов, кэш, пульт). Дальше: этап 6 (уведомления).
