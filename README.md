...
По этапам — [docs/06-mvp-roadmap.md](docs/06-mvp-roadmap.md). Версия **3.3.0** — завершён этап 3 (аккаунты, RBAC, безопасность, анкета → веса). Дальше: этап 4 (подбор и маршрутный лист).
